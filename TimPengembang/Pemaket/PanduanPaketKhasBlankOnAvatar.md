...
[q                 ]
    ...
    * Wiki  /
    * Pemaket  /
    * PanduanPaketKhasBlankOnAvatar
PANDUAN PEMAKETAN BLANKON AVATAR MENGGUNAKAN KOMPUTER LOKAL
   1. Sebelum melakukan pemaketan BlankOn Avatar silahkan persiapkan alatnya.
   ...
   2. Buka terminal, buat folder Paket di home dan masuk ke folder Paket/
      ...
      $cd Paket/
dan kemudian ketik
$bzr branch http://dev.blankonlinux.or.id/browser/tambora/blankon-avatar
untuk mengunduh folder kode sumber dari blankon-avatar dari bzr BlankOn.
[No_image_"#"_attached_to_Pemaket/PanduanPaketKhasBlankOnAvatar]
   1. Di folder Paket, masuk ke folder blankon-avatar, apabila melakukan
...
PEMAKETAN DI IRGSH
   1. Ketik
      $bzr branch http://dev.blankonlinux.or.id/browser/tambora/blankon-avatar
untuk mengunduh kode sumber dari blankon-avatar dari bzr BlankOn.
   1. Masuk ke folder blankon-avatar dan apabila melakukan perubahan pada kode
...
pemversian, komen, nama dan email anda.
   ...
   1. Kirim berkas blankon-avatar ke bzr
      ...
      paket
[No_image_"irgsh.png"_attached_to_Pemaket/PanduanPaketKhasBlankOnAvatar]
...
[No_image_"login.png"_attached_to_Pemaket/PanduanPaketKhasBlankOnAvatar]
Klik Login
   1. Klik New Build, maka akan muncul halaman Submit Build job
[No_image_"build.png"_attached_to_Pemaket/PanduanPaketKhasBlankOnAvatar]
6, Isikan
    ...
    * Additional Original Source = menambahkan source code upstream jika
      diperlukan.
[No_image_"submit.png"_attached_to_Pemaket/PanduanPaketKhasBlankOnAvatar]
7.Klik Submit
Last_modified 7 months ago Last modified on 10/11/2016 02:06:18 PM
#### 
